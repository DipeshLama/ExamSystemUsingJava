...
public class createEthicsQuestion extends JFrame implements ActionListener{
    ...
    public createEthicsQuestion(){
        ...
        displaylabel=new JLabel("Ethics Questions");
    ...
    public void actionPerformed(ActionEvent ae) {
       try{
             if(ae.getSource().equals(btnAdd)){
                ...
                int result=db.ethics_question_save(question,opt1,opt2,opt3,opt4,rightAns);               
                if (result>0)
                {
