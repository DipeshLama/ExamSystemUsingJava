...
public class createNetworkQuestion extends JFrame implements ActionListener {
    ...
    JButton btnAdd,btnclear,btnBack;
      public createNetworkQuestion(){
        ...
        displaylabel=new JLabel("Network Questions");
    ...
    public void actionPerformed(ActionEvent ae) {
        try{
             if(ae.getSource().equals(btnAdd)){
                ...
                {
                    JOptionPane.showMessageDialog(null,"Fill out sll the fields");
                }
                else
                {
                int result=db.network_question_save(question,opt1,opt2,opt3,opt4,rightAns);               
                if (result>0)
                {
